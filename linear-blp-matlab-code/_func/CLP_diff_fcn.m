function [irf_diff_store,se_store,prmtr_point_store,b1] = CLP_diff_fcn(endogenous_variables,controls,block_exogenous_controls,shock_series,l,orthogonalize,dummies1,dummies2,norm_sign,iv,h_max,p,neweywest,ld,leads)
% James Morley
% Updated 7 August 2026
% Calculates classical local projection estimates of changes in IRFs
%
%% INPUTS
%
