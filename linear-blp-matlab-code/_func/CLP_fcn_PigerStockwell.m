function [irf_store,se_store,prmtr_point_store,b1] = CLP_fcn_PigerStockwell(endogenous_variables,controls,block_exogenous_controls,shock_series,l,orthogonalize,dummies1,dummies2,norm_sign,iv,h_max,p,neweywest,ld,leads)
% James Morley
% Updated 7 August 2026
% Calculates classical local projection estimates of IRFs with Piger Stockwell specification
%
%% INPUTS
%
